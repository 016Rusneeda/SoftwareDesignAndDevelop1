...
|---------------|------------------------|----------|
| USR-01 | ระบบต้องรองรับการลงทะเบียนสมาชิกด้วย:<br>- ชื่อ-นามสกุล<br>- อีเมล (ใช้เป็น Username)<br>- รหัสผ่าน (ประกอบด้วย8ตัว พิมพ์ใหม่อย่างน้อย1 ตัว ตัวเลขอย่างน้อย 1 ตัว อักษรพิเศษอย่างน้อย 1 ตัว) <br>- เบอร์โทรศัพท์<br>- ที่อยู่ | High |
| USR-02 | ระบบต้องส่งอีเมลยืนยันตัวตนหลังการสมัครสมาชิก | High |
| USR-03 | ระบบต้องรองรับการลงทะเบียนผ่าน Social Media ดังนี้:<br>- Facebook <br>-Line <br>- Apple ID <br>- Gmail  | Medium |
...
| Requirement ID | Requirement Description | Priority |
|---------------|------------------------|----------|
| BKG-01 | ระบบต้องรองรับการค้นหาห้องพักตามเงื่อนไข:<br>- วันเช็คอิน-เช็คเอาท์<br>- จำนวนผู้เข้าพัก<br>- ประเภทห้อง ( ห้องเตียงคู่,เตียงเดียว )<br>- ช่วงราคา<br>- สิ่งอำนวยความสะดวก เช่น เครื่องปรับอากาศ ตู้เย็น ตู้เสื้อผ้า ผ้าเช็ดตัว | High |
| BKG-02 | ระบบต้องแสดงข้อมูลห้องพักโดยละเอียด:<br>- รูปภาพห้องพักแบบ Gallery<br>- ราคาและค่าใช้จ่ายเพิ่มเติม ( ระบุราคาของอาหารและเครื่อง และระบุค่าปรับเมื่อทำสิ่งของเสียหาย )<br>- สิ่งอำนวยความสะดวก<br>- ขนาดห้องและจำนวนผู้เข้าพักสูงสุด<br>- นโยบายการเข้าพักและยกเลิก | High |
...
| PAY-02 | ระบบต้องแสดงรายละเอียดค่าใช้จ่ายทั้งหมดก่อนชำระเงิน <br>- แสดงราคาห้องพัก <br>- แสดงราคาส่วนลด <br>-แสดงราคาภาษีที่ต้องจ่าย <br>- แสดงราคาสุทธิที่ต้องจ่าย | High |
...
| ROM-02 | ระบบต้องคำนวณค่าใช้จ่ายเพิ่มเติมระหว่างเข้าพัก (เช่น ค่าปรับ ค่าอาหารและเครื่องดื่ม) | High |
...
| ADM-02 | ระบบต้องรองรับการจัดการประเภทห้อง:<br>- CRUD operations<br>- จัดการราคาและโปรโมชัน<br>- อัพโหลดรูปภาพ (รูปห้องนอน, ห้องน้ำ, ระเบียงและสิ่งต่างๆในห้อง )<br>- กำหนดสิ่งอำนวยความสะดวก | High |
| ADM-03 | ระบบต้องสามารถออกรายงานต่างๆ <br>- รายงานประจำสัปดาห์ <br>-รายงานประจำเดือน <br>-รายงานประจำปี| Medium |
